class CajasController < ApplicationController
  ...
  private
    ...
    def caja_params
      params.require(:caja).permit(:turno, :usuario, :doscientos, :cien, :cincuenta, :veinte, :diez, :cinco, :dos, :uno, :medio, :veintecentimos, :diezcentimos, :cincocentimos, :totalCalculo, :totalContado, :desvio)
    end
end
